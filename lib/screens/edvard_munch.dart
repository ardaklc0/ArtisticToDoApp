...
String randomImage =  randomImageChooser("EdvardMunch");
class EdvardMunch extends StatefulWidget {
  const EdvardMunch({super.key, required this.title, this.plannerId, this.date});
  final String title;
  final int? plannerId;
  final String? date;
  @override
  State<EdvardMunch> createState() => _EdvardMunchState();
}
class _EdvardMunchState extends State<EdvardMunch> {
  ...
  void initState() {
    super.initState();
    List<Color> chosenColors = edvardMunchColors.firstWhere((element) => element.fileName.contains(randomImage)).colors;
