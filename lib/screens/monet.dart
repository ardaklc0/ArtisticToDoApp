...
import 'package:pomodoro2/services/monet_colors.dart';
...
class _MonetState extends State<Monet> {
  ...
  void initState() {
    super.initState();
    List<Color> chosenColors = monetColors.firstWhere((element) => element.fileName.contains(randomImage)).colors;
